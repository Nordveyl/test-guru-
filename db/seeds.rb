...
answers = Answer.create([
  { name: "Ruby on Rails", correct: true, question_id: tests[0].id }, 
  { name: "Camping", question_id: tests[0].id }, 
  { name: "Yes", question_id: tests[1].id }, 
  { name: "No", correct: true, question_id: tests[1].id }
])
